...
const PROGMEM uint16_t d_h_1[] = {REST, 30000, 30000};

const PROGMEM uint16_t n_l_2[] = {NOTE_A5,REST,NOTE_A5,REST,REST};
const PROGMEM uint16_t d_l_2[] = {2000, 3000, 2000, 3000,3000};
const PROGMEM uint16_t n_m_2[] = {NOTE_A4,REST,NOTE_A4,REST,REST};
const PROGMEM uint16_t d_m_2[] = {2000, 3000, 2000, 3000,3000};
const PROGMEM uint16_t n_h_2[] = {NOTE_A3,REST,NOTE_A3,REST,REST};
const PROGMEM uint16_t d_h_2[] = {2000, 3000, 2000, 3000,3000};
